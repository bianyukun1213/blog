...
class SmI18n {
    ...
    initPopContentHtml(minimumSupportedBrowserVersions, referrerKey, postProcessor) {
        ...
        if (this.isEn()) {
            ...
            <p>本站的部分资源托管在国外，在中国大陆的网络环境下可能无法正常加载。如果您在中国大陆访问本站，推荐使用代理。本站使用的部分特性需要 Chrome/Chromium ${minimumSupportedBrowserVersions.chrome}、Safari ${minimumSupportedBrowserVersions.safari}、Firefox ${minimumSupportedBrowserVersions.firefox} 及以上版本的支持。部分内容如文章总结及图片标注可能由 AI 生成，仅供参考。</p>
