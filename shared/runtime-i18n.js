...
class SmI18n {
    ...
    initPopContentHtml(minimumSupportedBrowserVersions, referrerKey, postProcessor) {
        ...
        if (this.isEn()) {
            ...
            <p>Most resources on this site are hosted outside Chinese mainland and may not load properly under the network environment in Chinese mainland. If you visit this site in Chinese mainland, it is recommended to use a proxy. Some of the features used on this site require Chrome/Chromium ${minimumSupportedBrowserVersions.chrome}, Safari ${minimumSupportedBrowserVersions.safari}, Firefox ${minimumSupportedBrowserVersions.firefox} or above. Some content such as post summaries and image captions may have been generated by AI and are for reference only. There are few accessibility functions implemented on this site, so if you have trouble browsing, consider using <a href="/${this.#lang}/atom.xml" target="_blank">the RSS feed</a>.</p>
